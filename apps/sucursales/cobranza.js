...
function loadDemoData(){
  ...
  getDrawTable('firstElement', columsTable1, dataTable1, 380)
  document.getElementById("firstElement").style.removeProperty('display');

  getDrawTable('secondElement', columsTable2, dataTable2, 380)
...
//-----CHANGE STOP
function setTransition(option) {
  if (option == 1) {
    $("#buttonCartera").addClass("active");
    $("#buttonVencidos").removeClass("active");
    $("#buttonAnticipos").removeClass("active");
  }else if(option == 2){
    $("#buttonCartera").removeClass("active");
    $("#buttonVencidos").addClass("active");
    $("#buttonAnticipos").removeClass("active");
  }
  else if(option == 3){
    $("#buttonCartera").removeClass("active");
    $("#buttonVencidos").removeClass("active");
    $("#buttonAnticipos").addClass("active");
  }
}