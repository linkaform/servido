...
var sectores1 = L.geoJSON(sectores, { style: styler, onEachFeature: function (feature, layer) { layer.bindPopup("<h4>Información de Sector</h4><hr>"+"<strong> Nombre del Sector : </strong>"+feature.properties.SECTOR+"<br/>"+"<strong> Estado Sector: </strong>"+feature.properties.ESTADO+"</br>"); } });
